...
public abstract class AbstractArchitectureTestEvaluatorTest {
  ...
  protected static final int NUMBER_OF_DEFAULT_TESTS = 11;

  protected TypeSafeMatcher<Map<String, Set<Class<?>>>> contains(Class<?> clazz) {
  ...
  protected void verify(Map<String, Set<Class<?>>> targetMap, Class<?>... classes) {
